...
# Patched: updated base_url to https and improved session handling.
...
class ISTAT:
    ...
    def __init__(self):
        # FIX: changed http:// to https:// and hostname to esploradati.istat.it 
        # (modern endpoint containing recent dataflows like FOI 2025)
...
def get_custom_ssl_session():
    '''Get a requests session with a permissive SSL context'''
